        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header ">
              <h3 class="card-title">{{ __('message.edit') }} {{ __('message.Admin') }}</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form>
              ...
              <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" value="{{ $admins->user->name }}" name="name" id="name" >
                    </div>

                    <div class="form-group col-md-6">
                        <label for="identity">{{ __('message.identity') }}</label>
                        <input type="number" class="form-control" value="{{ $admins->user->identity }}" name="identity" id="identity" >
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="email" class="form-control" value="{{ $admins->email }}" name="email" id="email" >
                    </div>
                    {{-- <div class="form-group col-md-6">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                      <label for="mobile">{{ __('message.mobile') }}</label>
                        <input type="text" class="form-control" value="{{ $admins->user->mobile }}" name="mobile" id="mobile" >
                    </div>
                    <div class="form-group col-md-6">
                      <label for="address">{{ __('message.address') }}</label>
                        <input type="text" class="form-control" value="{{ $admins->user->address }}" name="address" id="address" >
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" class="form-control" name="dob" value="{{ $admins->user->dob }}" id="dob" placeholder="Enter date of birthday of Admin">
                    </div>
                    <div class="form-group col-md-3">
                        <label for="fileType">{{ __('message.file type') }}</label>
                        <select name="fileType" id="fileType" value="{{ $admins->user->attachment->fileType }}" class="form-select form-select-sm" style="width: 100%;">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="file" class="form-control" value="{{ $admins->user->attachment->fileUrl }}" name="fileUrl" id="fileUrl" placeholder="Enter url of file">
                    </div>
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="gender" id="gender" value="{{ $admins->user->gender }}" class="form-select form-select-sm" style="width: 100%;">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="status" id="status" value="{{ $admins->user->status }}" class="form-select form-select-sm" style="width: 100%;">
