                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            ...
                            <h3 class="card-title"> {{__('create_edit.Another Expenses')}}</h3>
                        </div>
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name='name' id="name" placeholder="{{ __('create_edit.Enter Name') }}" >
...
<script>
    ...
    function performStore(){
        ...
        store('/cms/anotherexpenses' , fromData)
    }
