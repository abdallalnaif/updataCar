                            ...
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="email" class="form-control" name='email' id="email" placeholder="{{ __('create_edit.email') }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control" name='count' id="count"  placeholder="{{ __('create_edit.count') }}">
                                        </div>
