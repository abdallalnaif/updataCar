              ...
              <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" value="{{ $admins->user->name }}" name="name" id="name" placeholder="Enter Name of Admin">
                    </div>

                    <div class="form-group col-md-6">
                        <label for="identity">identity of Admin</label>
                        <input type="number" class="form-control" value="{{ $admins->user->identity }}" name="identity" id="identity" placeholder="Enter identity of Admin">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="email" class="form-control" value="{{ $admins->email }}" name="email" id="email" placeholder="Enter Name of Admin">
                    </div>
                    {{-- <div class="form-group col-md-6">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                      <label for="mobile">Mobile of Admin</label>
                        <input type="text" class="form-control" value="{{ $admins->user->mobile }}" name="mobile" id="mobile" placeholder="Enter Name of Admin">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="address"> Address of Admin</label>
                        <input type="text" class="form-control" value="{{ $admins->user->address }}" name="address" id="address" placeholder="Enter Name of Admin">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" class="form-control" value="{{ $admins->user->dob }}" name="dob" id="dob" placeholder="Enter date of birthday of Admin">
                    </div>
